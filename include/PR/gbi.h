...
{									\
	...
	_g->words.w1 = _GFXW1_PTR(s);				\
}

#define	gsDma0p(c, s, l)						\
{{									\
	_SHIFTL((c), 24, 8) | _SHIFTL((l), 0, 24), _GFXW1_PTR(s)	\
}}
