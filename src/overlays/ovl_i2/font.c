...
// The glyph occupies the left 8 pixels, and the port's renderer keeps sampling at the
// 16-pixel source stride, so the width override still lands on the right texels.
